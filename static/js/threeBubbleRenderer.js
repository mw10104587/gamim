...
Physics.renderer('threeBubbles', function( proto ){
    ...
    return {
		...
		$(options.el).appendChild( this.renderer.domElement );
        ...
        drawBody: function( body, view )
	{
		if (body.sprite == 'undefined')
		{
			...
			body.sprite = new THREE.Sprite( material );
			this.scene.add( body.sprite );
		}
        }
    };
});
